...
const config: Config = {
  ...
  tagline: 'An Interactive Book on Embodied AI and Humanoid Robot Control',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/your-username/physical-ai-robotics-book',
        },
        blog: {
      ...
      links: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              to: '/docs/chapter-1-robotic-nervous-system',
            },
            {
              label: 'Gazebo & Unity - The Digital Twin',
              to: '/docs/chapter-2-digital-twin',
            },
            {
              label: 'NVIDIA Isaac - The AI-Robot Brain',
              to: '/docs/chapter-3-ai-robot-brain',
            },
            {
              label: 'Vision-Language-Action (VLA)',
              to: '/docs/chapter-4-vision-language-action',
            },
            {
              label: 'Conclusion',
              to: '/docs/conclusion',
