        ...
        routes: [
          {
            ...
            routes: [
              {
                path: '/docs/chapter-1-robotic-nervous-system',
                component: ComponentCreator('/docs/chapter-1-robotic-nervous-system', 'fed'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/chapter-2-digital-twin',
                component: ComponentCreator('/docs/chapter-2-digital-twin', '4ed'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/chapter-3-ai-robot-brain',
                component: ComponentCreator('/docs/chapter-3-ai-robot-brain', 'b13'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/chapter-4-vision-language-action',
                component: ComponentCreator('/docs/chapter-4-vision-language-action', '6fb'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
